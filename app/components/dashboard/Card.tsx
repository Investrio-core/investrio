...
export const Card = ({
  ...
  return (
    <div className="flex justify-between gap-4 rounded-xl border-b-2 border-r-2 border border-[#EDF2F6] bg-white py-4 px-5 w-full">
      <div>
      ...
      {withEdit && (
        <IconButton onClick={onEditClick} Icon={EditIcon} className="self-end max-[1210px]:self-start"/>
      )}
    </div>
  );
};
