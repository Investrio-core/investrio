const personalFinanceCategories = {
  INCOME: {
    ...
    INCOME_INTEREST_EARNED: "Income from interest on savings accounts",
    INCOME_RETIREMENT_PENSION: "Income from pension payments ",
    INCOME_TAX_REFUND: "Income from tax refunds",
    INCOME_UNEMPLOYMENT:
      "Income from unemployment benefits, including unemployment insurance and healthcare",
    INCOME_WAGES: "Income from salaries, gig-economy work, and tips earned",
    INCOME_OTHER_INCOME:
  ...
  TRANSFER_IN: {
    ...
    TRANSFER_IN_DEPOSIT: "Cash, checks, and ATM deposits into a bank account",
    TRANSFER_IN_INVESTMENT_AND_RETIREMENT_FUNDS:
      "Inbound transfers to an investment or retirement account",
    TRANSFER_IN_SAVINGS: "Inbound transfers to a savings account",
    TRANSFER_IN_ACCOUNT_TRANSFER:
      "General inbound transfers from another account",
    TRANSFER_IN_OTHER_TRANSFER_IN: "Other miscellaneous inbound transactions",
  },
  TRANSFER_OUT: {
    TRANSFER_OUT_INVESTMENT_AND_RETIREMENT_FUNDS:
      "Transfers to an investment or retirement account, including investment apps such as Acorns, Betterment",
    TRANSFER_OUT_SAVINGS: "Outbound transfers to savings accounts",
    TRANSFER_OUT_WITHDRAWAL: "Withdrawals from a bank account",
  ...
  LOAN_PAYMENTS: {
    LOAN_PAYMENTS_CAR_PAYMENT: "Car loans and leases",
    ...
    LOAN_PAYMENTS_MORTGAGE_PAYMENT: "Payments on mortgages",
    LOAN_PAYMENTS_STUDENT_LOAN_PAYMENT:
      "Payments on student loans. For college tuition, refer to General Services - Education",
    LOAN_PAYMENTS_OTHER_PAYMENT: "Other miscellaneous debt payments",
  },
  BANK_FEES: {
    BANK_FEES_ATM_FEES: "Fees incurred for out-of-network ATMs",
    BANK_FEES_FOREIGN_TRANSACTION_FEES:
      "Fees incurred on non-domestic transactions",
    BANK_FEES_INSUFFICIENT_FUNDS: "Fees relating to insufficient funds",
    BANK_FEES_INTEREST_CHARGE:
      "Fees incurred for interest on purchases, including not-paid-in-full or interest on cash advances",
    BANK_FEES_OVERDRAFT_FEES: "Fees incurred when an account is in overdraft",
    BANK_FEES_OTHER_BANK_FEES: "Other miscellaneous bank fees",
  },
  ENTERTAINMENT: {
    ENTERTAINMENT_CASINOS_AND_GAMBLING: "Gambling, casinos, and sports betting",
    ...
    ENTERTAINMENT_VIDEO_GAMES: "Digital and in-person video game purchases",
    ENTERTAINMENT_OTHER_ENTERTAINMENT:
      "Other miscellaneous entertainment purchases, including night life and adult entertainment",
  },
  FOOD_AND_DRINK: {
    FOOD_AND_DRINK_BEER_WINE_AND_LIQUOR: "Beer, Wine & Liquor Stores",
    FOOD_AND_DRINK_COFFEE: "Purchases at coffee shops or cafes",
    FOOD_AND_DRINK_FAST_FOOD: "Dining expenses for fast food chains",
  ...
  GENERAL_MERCHANDISE: {
    ...
    GENERAL_MERCHANDISE_CLOTHING_AND_ACCESSORIES: "Apparel, shoes, and jewelry",
    GENERAL_MERCHANDISE_CONVENIENCE_STORES: "Purchases at convenience stores",
    ...
    GENERAL_MERCHANDISE_ELECTRONICS: "Electronics stores and websites",
    ...
    GENERAL_MERCHANDISE_PET_SUPPLIES: "Pet supplies and pet food",
  ...
  HOME_IMPROVEMENT: {
    HOME_IMPROVEMENT_FURNITURE: "Furniture, bedding, and home accessories",
    ...
    HOME_IMPROVEMENT_SECURITY: "Home security system purchases",
    HOME_IMPROVEMENT_OTHER_HOME_IMPROVEMENT:
      "Other miscellaneous home purchases, including pool installation and pest control",
  },
  MEDICAL: {
    MEDICAL_DENTAL_CARE: "Dentists and general dental care",
    MEDICAL_EYE_CARE: "Optometrists, contacts, and glasses stores",
    MEDICAL_NURSING_CARE: "Nursing care and facilities",
    MEDICAL_PHARMACIES_AND_SUPPLEMENTS: "Pharmacies and nutrition shops",
    MEDICAL_PRIMARY_CARE: "Doctors and physicians",
    MEDICAL_VETERINARY_SERVICES: "Prevention and care procedures for animals",
  ...
  GENERAL_SERVICES: {
    ...
    GENERAL_SERVICES_AUTOMOTIVE: "Oil changes, car washes, repairs, and towing",
    GENERAL_SERVICES_CHILDCARE: "Babysitters and daycare",
    GENERAL_SERVICES_CONSULTING_AND_LEGAL: "Consulting and legal services",
    GENERAL_SERVICES_EDUCATION:
      "Elementary, high school, professional schools, and college tuition",
    GENERAL_SERVICES_INSURANCE: "Insurance for auto, home, and healthcare",
    GENERAL_SERVICES_POSTAGE_AND_SHIPPING:
      "Mail, packaging, and shipping services",
    GENERAL_SERVICES_STORAGE: "Storage services and facilities",
  ...
  TRANSPORTATION: {
    TRANSPORTATION_BIKES_AND_SCOOTERS: "Bike and scooter rentals",
    TRANSPORTATION_GAS: "Purchases at a gas station",
    TRANSPORTATION_PARKING: "Parking fees and expenses",
    TRANSPORTATION_PUBLIC_TRANSIT:
      "Public transportation, including rail and train, buses, and metro",
    TRANSPORTATION_TAXIS_AND_RIDE_SHARES: "Taxi and ride share services",
    TRANSPORTATION_TOLLS: "Toll expenses",
    TRANSPORTATION_OTHER_TRANSPORTATION:
      "Other miscellaneous transportation expenses",
  },
  TRAVEL: {
    TRAVEL_FLIGHTS: "Airline expenses",
    TRAVEL_LODGING: "Hotels, motels, and hosted accommodation such as Airbnb",
    TRAVEL_RENTAL_CARS: "Rental cars, charter buses, and trucks",
    TRAVEL_OTHER_TRAVEL: "Other miscellaneous travel expenses",
  },
  RENT_AND_UTILITIES: {
    RENT_AND_UTILITIES_GAS_AND_ELECTRICITY: "Gas and electricity bills",
    RENT_AND_UTILITIES_INTERNET_AND_CABLE: "Internet and cable bills",
    RENT_AND_UTILITIES_RENT: "Rent payment",
    RENT_AND_UTILITIES_SEWAGE_AND_WASTE_MANAGEMENT:
      "Sewage and garbage disposal bills",
    RENT_AND_UTILITIES_TELEPHONE: "Cell phone bills",
    RENT_AND_UTILITIES_WATER: "Water bills",
    RENT_AND_UTILITIES_OTHER_UTILITIES: "Other miscellaneous utility bills",
  },
};

export default personalFinanceCategories;
