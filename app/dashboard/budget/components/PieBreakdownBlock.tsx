...
export default function PieBreakdownBlock({ income }: { income: number }) {
  return (
    <div className="flex flex-col pb-[24px]">
      <div className="pb-[24px] mx-[16px] lg:my-[16px] xl:px-10 bg-indigo-50 rounded-[18px] border border-violet-200">
        <ScaledPieChart income={income} height={180} title="Suggested Budget" />
      </div>
